...
export default class Location {
     ...
     * @param {String} heb The name of the Location
     ...
     */
    constructor(name, heb, israel, latitude, longitude, utcOffset, elevation, candleLighting) {
    ...
    static getJerusalem() {
        return new Location('Jerusalem', 'ירושלים', true, 31.78, -35.22, 2, 775, 40);
    }
    /**Gets the Location for Lakewood NJ*/
    static getLakewood() {
        return new Location('Lakewood NJ', false, 40.1, 74.23, -5, 0, 18);
    }
}